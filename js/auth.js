class Auth {
    ...
    static loggedInNavbar() {
      ...
      span.innerHTML = `${Auth.current_user} <a href="#" class="logoutLink bg-gray-400 px-4 py-2">Logout</a>`
      return span;
    }
    ...
    static loginForm() {
      ...
      this.loginFormElement.innerHTML = `
        ...
        <div class="grid grid-cols-2 gap-2">
          ...
          />
          <input 
            class="multi-submit bg-purple-500 hover:bg-purple-700 transition duration-200 text-white font-bold py-2 px-4 w-full rounded focus:outline-none focus:shadow-outline" 
            type="submit"
            value="Signup"
          />
        </div>
    ...
    static logout() {
      return fetch('http://localhost:3000/logout', {  
        ...
        .then(({message}) => {
          ...
          Ingredient.container().innerHTML = '';
